        ...
        if(getBeanSessionRegistrarGuia().getExec() == 0){
            ...
            if(Utils.getSession("GUIA") != null){//Modificar
               ...
               // getBeanSessionRegistrarGuia().setCodUN(beanGuia.getCidGuia().substring(0,beanGuia.getCidGuia().indexOf("-")));
                beanSessionRegistrarGuia.setCodUN(beanGuia.getCidUnidadNegocio());
                ...
                System.out.println("TIENE MANIFIESTO");
                    ...
                    beanSessionRegistrarGuia.setManifiestoSeleccionado(manif.getNidManifiesto()+" - "+manif.getTrManifiesto().getCRazonSocial());
                    beanSessionRegistrarGuia.setNidManifiesto(manif.getNidManifiesto());                
                }
